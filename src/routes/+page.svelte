...
<div class="absolute right-2 top-2">
	<label class="swap swap-rotate">
		<input type="checkbox" on:change={changetheme} bind:value={theme} />
...
<div class="flex h-screen w-screen flex-col">
	...
	<div class="flex flex-1 flex-col content-center items-center justify-center">
		<div class="flex flex-col gap-y-16">
			<div class="card w-96 bg-base-200 p-5 shadow-xl">
				<h1 class="card-title self-center text-center text-2xl font-bold">
				...
				<div class="card-body">
					...
					<button
						...
						disabled={selectedGrade == 'Unselected'}
						on:click={transitionToNextPage}
					>
						Explore the Sky
					</button>
				</div>
